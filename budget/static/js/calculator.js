...
function myFunction() {
  var copyText = document.getElementById("calc_result");
  copyText.select();
  copyText.setSelectionRange(0, 99999);
  document.execCommand("copy");
  $('.integratecalculator').slideToggle("slow");
...
function hidecalc(){
        $('.contentcalc').slideToggle("slow");
        $('.calculator').css({"height":"100px"});
        document.getElementById("calc_result").focus();
        if($('#contentofcalc').text() == "Show"){
                $('#contentofcalc').text("Hide");
                return;
        }
        if($('#contentofcalc').text() == "Hide"){
                $('#contentofcalc').text("Show");
                return;
        }
}